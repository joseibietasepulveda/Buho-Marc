...
export function WatchPanel({ onOpen, onRefresh, onCases, initialQuery = "" }: Props) {
  ...
  return <section className="watch-view">
    ...
    {tab === 'discover' && <p className="watch-help">{data?.demoOrderExpiresAt ? "Orden de demostración: comparaciones seleccionadas primero hasta las 23:00 de hoy." : "Primero verás las marcas con mayor similitud."} Se incluyen solicitudes en trámite y marcas concedidas; los expedientes terminados o sin estado confirmado no aparecen en Por revisar.</p>}

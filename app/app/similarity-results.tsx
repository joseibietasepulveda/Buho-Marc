...
export function SimilarityCard({ hit, position, children, queryImage, queryName, selected, onSelect }: { hit: SimilarityHit; position?: number; children?: React.ReactNode; queryImage?: string; queryName?: string; selected?:boolean; onSelect?:()=>void }) {

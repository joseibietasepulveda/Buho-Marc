...
test("the navigable demo exposes its main product modules", async () => {
  ...
  for (const label of ["Resumen Vigilancia", "Mis marcas", "Vigilancia", "Casos", "Resumen de registros", "Revisor de factibilidad", "Solicitudes de registro", "Notificaciones", "Usuarios", "Bitácora de auditoría", "Acerca de esta versión"]) {
...
test("Railway applies migrations and checks the PostgreSQL connection", async () => {
  ...
  assert.match(health, /engine:.*"dequienes".*"not-configured"/);
});
